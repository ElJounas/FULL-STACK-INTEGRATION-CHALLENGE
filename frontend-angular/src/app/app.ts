...
@Component({
  selector: 'app-root',
  standalone: true,
  imports: [CommonModule, ProductoListaComponent, PedidoListaComponent],
  template: `
    <div style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; background-color: #f8f9fa; min-height: 100vh;">
      ...
      <!-- Vista de la Sección Seleccionada -->
...
export class App {
  ...
  seccionActual: 'productos' | 'pedidos' = 'productos';
}